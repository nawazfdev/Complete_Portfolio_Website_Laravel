...
<img src="{{ asset('backend/assets/images/logo-light.png') }}" height="30" class="logo-light mx-auto" alt="">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b> Tenants Registration</b></h4>
    
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('tenants.store') }}" >
        @csrf
            ...
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" id="domainname" name="domainname" type="text" required="" placeholder="DomaiName">
